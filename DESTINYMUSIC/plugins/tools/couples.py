...
from DESTINYMUSIC.mongo.couples_db import get_couple, save_couple
...
async def safe_photo(uid: int, name: str):
    fallback = "DESTINYMUSIC/assets/upic.png"
    try:
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open("DESTINYMUSIC/assets/DESTINY/DESTINYCP.png")
