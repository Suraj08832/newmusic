...
# CONFIG
# ─────────────────────────────
BG_PATH      = "DESTINYMUSIC/assets/DESTINY/DESTINYNwel.png"
FALLBACK_PIC = "DESTINYMUSIC/assets/upic.png"
FONT_PATH    = "DESTINYMUSIC/assets/DESTINY/ArialReg.ttf"
...
async def welcome(client, update: ChatMemberUpdated):
    ...
    try:
        ...
        for f in (avatar, img):
            if f and os.path.exists(f) and "DESTINYMUSIC/assets" not in f:
                try: os.remove(f)
                except: pass
