...
from DESTINYMUSIC import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from DESTINYMUSIC.core.call import JARVIS
from DESTINYMUSIC.utils import seconds_to_min, time_to_seconds
from DESTINYMUSIC.utils.channelplay import get_channeplayCB
from DESTINYMUSIC.utils.decorators.language import languageCB
from DESTINYMUSIC.utils.decorators.play import PlayWrapper
from DESTINYMUSIC.utils.errors import capture_err, capture_callback_err
from DESTINYMUSIC.utils.formatters import formats
from DESTINYMUSIC.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from DESTINYMUSIC.utils.logger import play_logs
from DESTINYMUSIC.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("DESTINYPlaylists") & ~BANNED_USERS)
@languageCB
@capture_callback_err
