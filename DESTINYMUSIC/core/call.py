...
from DESTINYMUSIC import LOGGER, YouTube, app
from DESTINYMUSIC.misc import db
from DESTINYMUSIC.utils.database import (
    add_active_chat,
...
from DESTINYMUSIC.utils.exceptions import AssistantErr
from DESTINYMUSIC.utils.formatters import check_duration, seconds_to_min, speed_converter
from DESTINYMUSIC.utils.inline.play import stream_markup
from DESTINYMUSIC.utils.stream.autoclear import auto_clean
from DESTINYMUSIC.utils.thumbnails import get_thumb
from DESTINYMUSIC.utils.errors import capture_internal_err, send_large_error
...
class Call:
    def __init__(self):
        self.userbot1 = Client("DESTINYXAssis1", config.API_ID, config.API_HASH, session_string=config.STRING1) if config.STRING1 else None
        self.one = PyTgCalls(self.userbot1) if self.userbot1 else None

        self.userbot2 = Client("DESTINYXAssis2", config.API_ID, config.API_HASH, session_string=config.STRING2) if config.STRING2 else None
        self.two = PyTgCalls(self.userbot2) if self.userbot2 else None

        self.userbot3 = Client("DESTINYXAssis3", config.API_ID, config.API_HASH, session_string=config.STRING3) if config.STRING3 else None
        self.three = PyTgCalls(self.userbot3) if self.userbot3 else None

        self.userbot4 = Client("DESTINYXAssis4", config.API_ID, config.API_HASH, session_string=config.STRING4) if config.STRING4 else None
        self.four = PyTgCalls(self.userbot4) if self.userbot4 else None

        self.userbot5 = Client("DESTINYXAssis5", config.API_ID, config.API_HASH, session_string=config.STRING5) if config.STRING5 else None
